...
#include "iicthread.h"//IIC线程
#include "serialportthread.h"//串口线程
...
private slots:
       ...
       void on_spinBoxAxis_valueChanged(int arg1);
...
private:
    ...
    IICThread *pIICThread = nullptr;//IIC线程指针
    SerialPortThread *pSerialPortThread = nullptr;//串口线程指针
